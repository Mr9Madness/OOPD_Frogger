package nl.han.ica.OOPD_Engine.Objects;

import nl.han.ica.OOPD_Engine.UserInput.IKeyInput;
import nl.han.ica.OOPD_Engine.UserInput.IMouseInput;
...
public abstract class GameObject implements IKeyInput, IMouseInput, PConstants {
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.OOPD_Engine.UserInput.IKeyInput#keyPressed(int, char)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.OOPD_Engine.UserInput.IKeyInput#keyReleased(int, char)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.OOPD_Engine.UserInput.IMouseInput#mousePressed(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.OOPD_Engine.UserInput.IMouseInput#mouseReleased(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.OOPD_Engine.UserInput.IMouseInput#mouseClicked(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.OOPD_Engine.UserInput.IMouseInput#mouseMoved(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.OOPD_Engine.UserInput.IMouseInput#mouseDragged(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.OOPD_Engine.UserInput.IMouseInput#mouseWheel(int)
     */
